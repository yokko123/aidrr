...
#from posture_detection.demo import posture_detect
...
#from posture_detection import demo
...
def detect(opt):
    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            # kpi2_text.write(f"<h5 style= 'text-align:left; color: red'>{}</h5>")
            # kpi3_text.write(f"<h5 style= 'text-align:left; color: red'>{w}</h5>")
            if show_vid:
